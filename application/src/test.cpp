...
namespace CW {
    ...
    private:
        ...
        void UpdateInterface() 
        {
            if (g_DebugMenuOpen)
            {
                if (ImGui::Begin("Debug", &g_DebugMenuOpen))
                {
    ...
    private:
        Unique<sf::Sprite> m_StartButtonSprite;
        Unique<sf::Sprite> m_ExitButtonSprite;
