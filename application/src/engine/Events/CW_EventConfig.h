...
//
#define CW_USER_EVENTS_LIST CreateBeacon, CloseApp, StartSimulation, SetSimulationSettings, SpawnDrone, SwitchMenu, SwitchDebugMenu, SaveSimulation, LoadSimulation